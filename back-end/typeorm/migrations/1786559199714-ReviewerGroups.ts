...
export class ReviewerGroups1786559199714 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "group_change_record" ("id" SERIAL NOT NULL, "groupId" integer, "snapshotVersion" integer NOT NULL, "snapshotPayload" jsonb NOT NULL, "attestationSignatures" jsonb NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_af3eade3089345c6cd5076837b5" PRIMARY KEY ("id"))`);
