...
export class ReviewerGroups1786559199714 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rule_change_record" ("id" SERIAL NOT NULL, "ruleId" integer, "groupId" integer, "action" character varying NOT NULL, "rulePayload" jsonb NOT NULL, "attestationSignatures" bytea, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_3cbbd11fcf1c8e23b395809748b" PRIMARY KEY ("id"))`);
