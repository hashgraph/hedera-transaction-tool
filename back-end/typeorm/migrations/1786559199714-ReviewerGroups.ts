...
export class ReviewerGroups1786559199714 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "rule_change_record" ADD CONSTRAINT "FK_rule_change_record_userId" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "rule_change_record" ADD CONSTRAINT "FK_rule_change_record_userKeyId" FOREIGN KEY ("userKeyId") REFERENCES "user_key"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "group_change_record" ADD CONSTRAINT "FK_group_change_record_userId" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "group_change_record" ADD CONSTRAINT "FK_group_change_record_userKeyId" FOREIGN KEY ("userKeyId") REFERENCES "user_key"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "group_change_record" DROP CONSTRAINT "FK_group_change_record_userKeyId"`);
        await queryRunner.query(`ALTER TABLE "group_change_record" DROP CONSTRAINT "FK_group_change_record_userId"`);
        ...
        await queryRunner.query(`ALTER TABLE "rule_change_record" DROP CONSTRAINT "FK_rule_change_record_userKeyId"`);
        await queryRunner.query(`ALTER TABLE "rule_change_record" DROP CONSTRAINT "FK_rule_change_record_userId"`);
