...
export class ReviewerGroups1786559199714 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rule_change_record" ("id" SERIAL NOT NULL, "ruleId" integer, "groupId" integer, "userId" integer NOT NULL, "userKeyId" integer NOT NULL, "userSignature" character varying, "action" character varying NOT NULL, "status" character varying NOT NULL, "rulePayload" jsonb NOT NULL, "groupSnapshotVersion" integer, "attestationSignatures" jsonb, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_3cbbd11fcf1c8e23b395809748b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_rule_change_record_pending_ruleId" ON "rule_change_record" ("ruleId") WHERE (status = 'PENDING' AND "ruleId" IS NOT NULL)`);
        ...
        await queryRunner.query(`CREATE TABLE "group_change_record" ("id" SERIAL NOT NULL, "groupId" integer, "userId" integer NOT NULL, "userKeyId" integer NOT NULL, "userSignature" character varying, "type" character varying NOT NULL, "status" character varying NOT NULL, "snapshotVersion" integer NOT NULL, "snapshotPayload" jsonb NOT NULL, "attestationSignatures" jsonb NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_af3eade3089345c6cd5076837b5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f78e60ef232789ac6aa1c06607" ON "group_change_record" ("groupId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_group_change_record_pending_groupId" ON "group_change_record" ("groupId") WHERE (status = 'PENDING' AND "groupId" IS NOT NULL)`);
        ...
        await queryRunner.query(`ALTER TABLE "rule_change_record" ADD CONSTRAINT "FK_21645aef5ed25b8accb54570b26" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "rule_change_record" ADD CONSTRAINT "FK_1700e44543bb85b8cbfe7f41a6d" FOREIGN KEY ("userKeyId") REFERENCES "user_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "group_change_record" ADD CONSTRAINT "FK_668f625067e4dc25385f9194ecf" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "group_change_record" ADD CONSTRAINT "FK_207d2b3378a0bc56c72e33863a2" FOREIGN KEY ("userKeyId") REFERENCES "user_key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "group_change_record" DROP CONSTRAINT "FK_207d2b3378a0bc56c72e33863a2"`);
        await queryRunner.query(`ALTER TABLE "group_change_record" DROP CONSTRAINT "FK_668f625067e4dc25385f9194ecf"`);
        ...
        await queryRunner.query(`ALTER TABLE "rule_change_record" DROP CONSTRAINT "FK_1700e44543bb85b8cbfe7f41a6d"`);
        await queryRunner.query(`ALTER TABLE "rule_change_record" DROP CONSTRAINT "FK_21645aef5ed25b8accb54570b26"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_group_change_record_pending_groupId"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_rule_change_record_pending_ruleId"`);
