...
import {FileUpdateTransaction, KeyList, PublicKey, Timestamp} from '@hashgraph/sdk';

import {useToast} from 'vue-toast-notification';
import {useRoute} from 'vue-router';
import useAccountId from '@renderer/composables/useAccountId';

import {createTransactionId, encodeSpecialFileContent} from '@renderer/services/transactionService';
      ...
      <div class="form-group col-8 col-xxxl-6">
        ...
        <div class="d-flex gap-3">
          <AppInput
            v-model="newKeyText"
            :filled="true"
            placeholder="Update the keys on the file"
          />
        </div>
      </div>
