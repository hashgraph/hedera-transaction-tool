...
- **Check**: `[ ]` = must be manually verified before release (only for non-automated scenarios)
...
| 2. Login                        | 17              | 6         | 11      | 35%        |
| 3. Settings                     | 67              | 35        | 32      | 52%        |
| 4. Transactions List            | 34              | 15        | 19      | 44%        |
| 5. Transaction Creation         | 76              | 65        | 11      | 86%        |
| 6. Transaction Details          | 26              | 23        | 3       | 88%        |
| 7. Transaction Groups           | 34              | 28        | 6       | 82%        |
| 8. Accounts                     | 32              | 23        | 9       | 72%        |
| 9. Files                        | 26              | 7         | 19      | 27%        |
| 10. Contact List                | 19              | 11        | 8       | 58%        |
...
| 15. Upgrade                     | 3               | 0         | 3       | 0%         |
| **Total**                       | **419**         | **264**   | **155** | **63%**    |

### Release Testing Guide

The following sections highlight the most critical manual tests to perform before each release, organized by priority tier. All `[ ]` checkboxes in the tables above should be verified, but these are the scenarios that carry the highest risk if missed.
...
3. **Files (27%)** - File list sorting, file details panel, file actions, link existing file
...
6. **Notifications (50%)** - Real-time WebSocket delivery, email preference toggles
