...
onBeforeMount(async () => {
  if (
    ...
    throw new Error('Transaction is not Node Create or Update Transaction');
  }
...
<template>
  <div
    v-if="
      ...
      (transaction instanceof NodeUpdateTransaction && true)
    "
    class="mt-5 row flex-wrap"
  >
    <!-- Account ID -->
    <div
      v-if="transaction instanceof NodeUpdateTransaction && transaction.accountId"
      class="col-12 mb-3"
    >
    ...
    <div v-if="transaction instanceof NodeCreateTransaction && entityId" class="col-12 mb-3">
    ...
    <div
      ...
      class="col-12 my-3"
      :class="{ 'mt-3': transaction instanceof NodeUpdateTransaction && transaction.accountId }"
    >
